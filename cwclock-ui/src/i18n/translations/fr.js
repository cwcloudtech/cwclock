const fr = {
  ...
  organizations: {
    ...
    subfolderPathHint: "Sous-dossier dans lequel les factures sont écrites - dans le dépôt pour git, le bucket pour S3, ou le dossier pour Google Drive. Laissez vide pour utiliser sa racine.",
