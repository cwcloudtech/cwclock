const fr = {
  ...
  reports: {
    ...
    exportPdfPortrait: "Exporter en PDF (Portrait)",
    total: "Total",
    billable: "Facturable",
    days: "Jours",
    amount: "Montant",
  ...
  exportJobs: {
    ...
    noConnectionsForType: "Aucune connexion {{type}} configurée pour cette organisation. Ajoutez-en une dans les paramètres de l'organisation d'abord.",
    connectionNotFound: "Connexion introuvable (elle a peut-être été supprimée)",
