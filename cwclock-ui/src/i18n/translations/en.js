const en = {
  ...
  organizations: {
    ...
    gitPath: "Path (optional)",
    gitPathPlaceholder: "e.g. invoices/cwclock",
    gitPathHint: "Directory within the repo invoices are written under. Leave blank to use the repo root.",
  ...
  exportJobs: {
    ...
    noConnectionsForType: "No {{type}} connection configured for this organization yet. Add one from the organization's settings first.",
    connectionNotFound: "Connection not found (it may have been removed)",
