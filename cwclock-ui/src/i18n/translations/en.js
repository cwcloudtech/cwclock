const en = {
  ...
  auth: {
    ...
    openSourceBy: "Open source solution by ",
    cwcloudLinkLabel: "CWCloud.tech",
    openSourceSuffix: ", sources are available",
    here: "here",
    ...
    mfaVerify: "Verify",
    mfaUseSecurityKey: "Use a security key",
  },
  timeTracker: {
    ...
    half: "Half day",
    markHalf: "Mark as a half-day entry",
  ...
  profile: {
    ...
    mfaWebAuthn: "Security keys",
    mfaEnable: "Enable",
    mfaDisable: "Disable",
    mfaConfirm: "Confirm",
    mfaSecretHint: "Or enter this code manually: {{secret}}",
    mfaRegisterKey: "Register a security key",
    mfaSecurityKeyNamePrompt: "Name this security key",
    mfaSecurityKeyNameLabel: "Device name",
    mfaSecurityKeyDefaultName: "Security key",
    mfaDisableTitle: "Disable two-factor authentication",
    mfaDisableBody: "Disable the authenticator app for your account?",
    mfaDeleteKeyTitle: "Remove security key",
    mfaDeleteKeyBody: 'Remove the security key "{{name}}"? This cannot be undone.',
  },
  disabled: {
    adminMode: {
  ...
  organizations: {
    ...
    subfolderPath: "Subfolder (optional)",
    subfolderPathPlaceholder: "e.g. invoices/cwclock",
    subfolderPathHint: "Subfolder files are written under - within the repo for git, the bucket for S3, or the folder for Google Drive. Leave blank to use its root.",
    gitAuthMethod: "Authentication method",
    gitAuthMethodPassword: "Username / password",
    gitAuthMethodSshKey: "SSH key",
    gitUsername: "Username",
    gitPassword: "Password",
    sshPrivateKey: "SSH private key",
    sshPrivateKeyPassphrase: "SSH private key passphrase (optional)",
    flatDirectory: "Flat directory (no subfolders)",
    flatDirectoryHint: "Upload files directly at the root instead of nesting them under YYYY/MM folders - useful for accounting software that requires a flat listing.",
  ...
  admin: {
    ...
    disableMfaBody: 'Disable two-factor authentication for "{{email}}"? This cannot be undone.',
  },
  apiKeys: {
    title: "API Keys",
  ...
  toasts: {
    ...
    mfaDisabled: "Two-factor authentication disabled for this user.",
    timeRecordDeleted: "Time record deleted.",
    timeRecordUpdated: "Time record updated.",
    timeRecordCreated: "Time record created.",
  ...
  exportJobs: {
    ...
    newJob: "New Export Job",
    editJob: "Edit Export Job",
    ...
    cronExpressionRequired: "Please enter a cron expression.",
    timePeriod: "Time Period",
    timePeriodRequired: "Please select a time period.",
    reportTypes: "Report Types",
    selectReportTypes: "Select report types to export",
    clients: "Clients",
    allClientsSelected: "All clients will be included",
    projects: "Projects",
    allProjectsSelected: "All projects will be included",
    includeFinancialData: "Include financial data in reports",
    targetsLabel: "Targets",
    selectTargets: "Please add at least one target.",
    toEmails: "To (comma or semicolon separated)",
    ccEmails: "CC (comma or semicolon separated)",
    targetTypeEmail: "Email",
    targetType: "Target type",
    addTarget: "Add target",
    removeTarget: "Remove target",
    jobNamePlaceholder: "e.g., Daily Summary Report",
    createdSuccessfully: "Export job created successfully",
    updatedSuccessfully: "Export job updated successfully",
    deletedSuccessfully: "Export job deleted successfully",
    deleteConfirmTitle: "Delete export job",
    deleteConfirmMessage: 'Delete export job "{{name}}"? This cannot be undone.',
  },
};
