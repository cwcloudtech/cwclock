const en = {
  ...
  organizations: {
    ...
    subfolderPathHint: "Subfolder invoices are written under - within the repo for git, the bucket for S3, or the folder for Google Drive. Leave blank to use its root.",
